                    ...
                    <article className="max-w-[750px] mx-auto xl:ml-12 2xl:ml-16">
                        ...
                        <div className="prose prose-gray max-w-none text-base leading-relaxed text-gray-700">
                            <p className="text-lg text-gray-900 mb-8 border-b border-gray-100 pb-8">
                                A chatbot that only answers your questions is a tool. An intelligence that understands your company's deepest context, learns your specific workflows, and delegates tasks autonomously is an <strong>employee</strong>. Chrono represents the transition from the former to the latter.
                            </p>
                            ...
                            <p className="mb-6">
                                Chrono introduces <strong>Video-to-Workflow</strong> capability. You simply upload a screen recording of your human employee executing a task—like resolving a specific type of customer support ticket, or generating a weekly analytics report. Chrono's vision models break down the video frame-by-frame, reverse-engineering the steps into executable WebMCP skills. The AI watches you work once, and then takes over the job entirely.
                            </p>
                            ...
                            <p className="mb-6">
                                A true employee doesn't just do all the work themselves—they know when to hand things off. The AI running inside Chrono's workspace isn't trapped there.
                            </p>
                            ...
                            <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 mb-8 mt-4 font-mono text-sm leading-relaxed overflow-x-auto text-gray-800">
                                <p className="text-gray-500 mb-2">// How Chrono delegates a task to an external agent like OpenClaw</p>
                            ...
                            <p className="mb-6">
                                Because Chrono exposes web events to the browser securely, the internal AI can dispatch highly unstructured, external web tasks to execution agents like OpenClaw. "Cancel the Adobe subscription" or "Research our top 3 competitors and build a pricing spreadsheet." Chrono orchestrates the plan, delegates the external web navigation, and verifies the results. This transforms your workspace into an engine of work, where AI agents collaborate with each other to solve your problems.
                            </p>
            ...
            <div className="flex mx-auto max-w-[1440px] px-4 md:px-8">
                ...
                <main className="flex-1 py-10 min-w-0">
                    <article className="max-w-[750px] mx-auto xl:ml-12 2xl:ml-16">
                        ...
                        <div className="prose prose-gray max-w-none text-base leading-relaxed text-gray-700">
                            <p className="text-lg text-gray-900 mb-8 border-b border-gray-100 pb-8">
                                質問に答えるだけのチャットボットは単なる「ツール」に過ぎません。しかし、会社の深いコンテキストを理解し、特有のワークフローを学習し、自立してタスクを委任できるAIは<strong>「従業員」</strong>です。Chronoは前者を後者へと変革させます。
                            </p>
                            ...
                            <p className="mb-6">
                                一般的なAIツールの多くは、自律的に判断を下すための体系的なコンテキストを持っていません。真のAI従業員がチームに加わるとき、白紙の状態で始まるべきではありません。Chronoは内部エージェントに対し、会社の全体像を常に最新の状態で提供します。プロジェクト文書からチームのスケジュール、コードの変更履歴、タスクの依存関係まで全てをリアルタイムで把握しています。
                            </p>
                            <p className="mb-6">
                            ...
                            <p className="mb-6">
                                Chronoは<strong>Video-to-Workflow（動画からワークフローへの変換）</strong>機能を導入します。人間のスタッフが特定の種類の対応タスクや、週次の分析レポートを作成している画面の録画をアップロードするだけです。Chronoのビジョンモデルがその動画をフレームごとに分析し、ステップを逆算して実行可能なWebMCPスキルへと分解します。AIはあなたの作業を一度見るだけで、その後は業務を完全に引き継ぎます。
                            </p>
                            ...
                            <p className="mb-6">
                                優秀な従業員は、すべてを一人で抱え込むことはしません。適切なタイミングで仕事を他の人に任せます。Chrono上のAIは、ワークスペースの中に閉じ込められているわけではありません。
                            </p>

                            <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 mb-8 mt-4 font-mono text-sm leading-relaxed overflow-x-auto text-gray-800">
                                <p className="text-gray-500 mb-2">// Chronoが外部エージェント(OpenClawなど)にタスクを委任する例</p>
                                <p className="mb-4">window.dispatchEvent(new CustomEvent('OPENCLAW_TASK_DISPATCH', &#123;<br />
                                    &nbsp;&nbsp;detail: &#123;<br />
                            ...
                            <p className="mb-6">
                                Chronoはブラウザイベントを通じて安全に要求を発行できるため、内部のAIがOpenClawのような実行エージェントに対し、外部の非構造化されたウェブ操作タスクを委任できます。「Adobeのサブスクリプションを解約して」や「主要な競合3社を調査して料金表スプレッドシートを作成して」といった指示が可能です。Chronoがプランニングと指揮を行い、外部エージェントにWeb操作を委任し、その結果を検証します。これにより、ワークスペースは単なる記録ツールではなく、AI同士が協力して問題を解決する「作業エンジン」へと進化します。
                            </p>
