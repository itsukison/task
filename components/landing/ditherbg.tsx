...
void main() {
  ...
  if (invertColors == 1) {
    ...
    col = mix(vec3(1.0), waveColor, f);
  } else {
    // Black background with colored waves (original)
...
interface WaveUniforms {
    ...
    invertColors: THREE.Uniform<number>;
}
...
function DitheredWaves({
    ...
    const waveUniformsRef = useRef<WaveUniforms>({
        ...
        invertColors: new THREE.Uniform(invertColors ? 1 : 0)
    });
    ...
    useFrame(({ clock }) => {
        ...
        u.invertColors.value = invertColors ? 1 : 0;
