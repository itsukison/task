                ...
                <div className="text-center max-w-3xl mx-auto mb-10">
                    <Reveal delay={0.1}>
                        ...
                        <h2 className="text-4xl md:text-5xl lg:text-6xl font-medium tracking-tight text-foreground mb-6 leading-[1.1]">
                            {t('landing.testimonials.title_prefix')} <br />
                            {t('landing.testimonials.title_suffix')}
                        </h2>
                    </Reveal>
                    <Reveal delay={0.2}>
                            ...
                            <div className="rounded-[2rem] relative overflow-hidden h-full min-h-[320px] shadow-sm transform transition-all duration-500 hover:scale-[1.02]">
                                ...
                                <div className="relative z-10 p-8 h-full flex flex-col justify-between pointer-events-none">
                                    <div className="flex items-center gap-2 text-white/90">
                                        ...
                                        <span className="text-sm font-medium uppercase tracking-wider">{t('landing.testimonials.stat_impact')}</span>
                                    </div>

                                    <div>
                                        <h3 className="text-6xl font-medium text-white tracking-tight mb-2">{t('landing.testimonials.stat_hours')}</h3>
                                        <p className="text-white/80 font-medium text-xl leading-snug">{t('landing.testimonials.stat_desc')}</p>
                                    </div>
                                </div>
                            </div>
                        </Reveal>
                            ...
                            <div className="bg-white rounded-[2rem] p-10 flex flex-col justify-between h-full relative overflow-hidden border border-gray-100 shadow-sm transition-all hover:shadow-md">
                                ...
                                <div className="relative z-10 w-full">
                                    ...
                                    <h3 className="text-2xl md:text-3xl font-medium text-foreground tracking-tight leading-snug mb-8">
                                        &ldquo;{t('landing.testimonials.quote_1')}&rdquo;
                                    </h3>
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-400">{t('landing.testimonials.author_1_role')}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-[2rem] p-8 flex flex-col justify-between h-full min-h-[280px] relative overflow-hidden border border-gray-100 shadow-sm transition-all hover:shadow-md">
                                <div className="relative z-10">
                                    ...
                                    <p className="text-foreground/80 font-medium text-lg mb-6 leading-relaxed">
                                        &ldquo;{t('landing.testimonials.quote_2')}&rdquo;
                                    </p>
                                </div>
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <span className="text-sm text-gray-400">{t('landing.testimonials.author_2_role')}</span>
                                    </div>
                                </div>
                            </div>
                        </Reveal>
                            ...
                            <div className="rounded-[2rem] relative overflow-hidden h-full min-h-[280px] shadow-sm group">
                                ...
                                <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                                    <span className="bg-white/90 backdrop-blur-sm px-6 py-3 rounded-full text-foreground font-semibold tracking-tight shadow-lg">
                                        {t('landing.testimonials.visual_badge')}
                                    </span>
                                </div>
                            </div>
                        </Reveal>
                        ...
                        <Reveal delay={0.7} className="h-full">
                            <div className="bg-white rounded-[2rem] p-8 flex flex-col justify-between h-full min-h-[280px] relative overflow-hidden border border-gray-100 shadow-sm transition-all hover:shadow-md">
                                <div className="relative z-10">
                                    ...
                                    <p className="text-foreground/80 font-medium text-lg mb-6 leading-relaxed">
                                        &ldquo;{t('landing.testimonials.quote_3')}&rdquo;
                                    </p>
                                </div>
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <span className="text-xs text-gray-400">{t('landing.testimonials.author_3_role')}</span>
                                    </div>
                                </div>
                            </div>
                        </Reveal>
